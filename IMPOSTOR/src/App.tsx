...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 text-gray-900 font-sans overflow-hidden select-none">
      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6 pt-24">
        ...
        {gameState === "SETUP" && (
          ...
          >
            <div className="space-y-2">
              <h1 className="text-5xl font-black tracking-tighter uppercase italic">Quem Sabe?</h1>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="text-6xl font-black tabular-nums">{numPlayers}</span>
                  <button
        ...
        {gameState === "PLAYING" && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="w-full max-w-md flex flex-col items-center justify-center space-y-12 text-center"
          >
            ...
            <AnimatePresence mode="wait">
              {viewState === "NEUTRAL" ? (
                ...
                >
                  ...
                  <button
                    onClick={nextStep}
                    className="w-64 h-64 rounded-full bg-white border-8 border-gray-100 shadow-2xl flex flex-col items-center justify-center gap-4 hover:scale-105 active:scale-95 transition-all group relative overflow-hidden"
                  >
                    <motion.div 
                      animate={{ y: [0, -5, 0] }}
                      transition={{ repeat: Infinity, duration: 2 }}
                      className="w-24 h-24 rounded-full bg-gray-900 flex items-center justify-center text-white group-hover:bg-gray-800 transition-colors z-10"
                    >
                      <EyeOff size={40} />
                    </motion.div>
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="space-y-12 w-full py-12 bg-white rounded-[3rem] shadow-inner border border-gray-50"
                  >
                      ...
                      {currentPlayerIndex === impostorIndex ? (
                        <div className="space-y-4">
                          <motion.h2 
                            initial={{ y: 10 }}
                            animate={{ y: 0 }}
                            className="text-5xl font-black text-red-500 uppercase italic leading-none"
                          >
                        ...
                        <div className="space-y-4">
                          <motion.h2 
                            initial={{ y: 10 }}
                            animate={{ y: 0 }}
                            className="text-6xl font-black uppercase tracking-tighter leading-none break-words text-gray-900"
                          >
                            {word}
                          </motion.h2>
